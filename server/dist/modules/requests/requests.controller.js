...
exports.verifyDocument = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    try {
        ...
        const result = documentType === 'hospital'
            ? await (0, hospitalVerification_1.verifyHospitalDocument)(req.file.path, req.file.mimetype)
            : await (0, prescriptionVerification_1.verifyPrescriptionDocument)(req.file.path, req.file.mimetype);
