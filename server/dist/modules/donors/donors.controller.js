...
exports.getAllDonors = (0, catchAsync_1.catchAsync)(async (_req, res) => {
    ...
    const callerIsRequesterVerified = (callerRole === 'requester' || callerRole === 'hospital') && Boolean(_req.user?.isVerified);
...
exports.getNearbyDonors = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const callerIsRequesterVerified2 = (callerRole === 'requester' || callerRole === 'hospital') && Boolean(req.user?.isVerified);
...
exports.searchDonorsByCity = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const callerIsRequesterVerified3 = (callerRole === 'requester' || callerRole === 'hospital') && Boolean(req.user?.isVerified);
