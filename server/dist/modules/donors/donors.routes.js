...
const nearLimiter = (0, express_rate_limit_1.rateLimit)({
 ...
 */
router.get('/near', auth_1.protect, nearLimiter, donorsController.getNearbyDonors);
// Search donors by city name (geocoded on server)
router.get('/search', auth_1.protect, nearLimiter, donorsController.searchDonorsByCity);
